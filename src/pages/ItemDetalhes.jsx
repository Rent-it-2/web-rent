        ...
        <div className="flex flex-wrap">
          ...
          <div className="flex flex-col gap-10 px-8 py-2">
            ...
            <div className="">
              ...
              <p className="text-sm text-gray-400">Cobrança recorrente no cartão de crédito</p>
            </div>

            <div className="w-full flex gap-2">
              <button
                className="w-5/6 rounded-lg bg-primary p-3"
                onClick={alugarItem()}
              >
                Alugar
              </button>
              <button className="rounded-lg border-[1px] border-gray-400 p-1 px-3">
