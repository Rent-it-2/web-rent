        ...
        border-b-[1px] border-t-[1px] border-gray-300'>
            ...
            <div className="w-full flex items-center py-2 px-8">
                ...
                <ul className="w-full flex gap-5 items-center justify-between">
                    ...
                    <button className='rounded-full border-2 border-primary bg-primaryOpacity text-rentBlue px-8 py-2 hover:text-primary hover:bg-transparent'>Desapegar</button>
